<template>
    <div class="spec-container">
        <div class="title">
            <p>必选/多选</p><el-checkbox v-model="spec.num_related">是否与数量关联？</el-checkbox>
        </div>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        mounted(){
            this.spec =this.product.spec['required_multiple']
        ...
        methods: {
            ...
            addToVuex() {
                ...
                data.required = 1
                this.UPDATE_SPEC({type: 'required_multiple', data: data})
            }
        }
