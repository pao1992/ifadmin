<template>
    <div class="spec-container">
        <div class="title">
            <p>可选/多选</p><el-checkbox v-model="spec.num_related">是否与数量关联？</el-checkbox>
        </div>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        mounted(){
            this.spec =this.product.spec['unrequired_multiple']
            this.list = this.spec.items
            //this.num_related = Boolean(this.spec.num_related)
        ...
        methods: {
            ...
            addToVuex() {
                ...
                data.required = 0
                this.UPDATE_SPEC({type: 'unrequired_multiple', data: data})
            }
        }
